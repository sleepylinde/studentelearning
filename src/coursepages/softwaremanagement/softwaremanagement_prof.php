...
$file=fopen("softwaremanagement_desc.txt", "w");
fwrite($file, $desc);
fclose($file);
}
?>
...
<body>
    <header>
        <h1>Willkommen zu Ihrem Softwaremanagement Kursangebot! </h1>
    </header>
    <main>
        <div class="scroll text">
            ...
            <div class="course", style="float:left;">
                ...
                <textarea name="desc" rows="40" cols="40"><?php echo trim(file_get_contents('softwaremanagement_desc.txt'));?></textarea>
            ...
            <div class="upload">
                ...
                <p><?php
                    $dir_path = "../../resources/course files/softwaremanagement/abgaben/"; 
                    $ignoreList = array('.', '..');
