...
$file=fopen("itresearch_desc.txt", "w");
fwrite($file, $desc);
fclose($file);
}
?>
...
<body>
    <header>
        <h1>Willkommen zu Ihrem IT Research Kursangebot! </h1>
    </header>
    <main>
        <div class="scroll text">
            ...
            <div class="course", style="float:left;">
                ...
                <textarea name="desc" rows="40" cols="40"><?php echo trim(file_get_contents('itresearch_desc.txt'));?></textarea>
            ...
            <div class="upload">
                ...
                <p><?php
                    $dir_path = "../../resources/course files/itresearch/abgaben/"; 
                    $ignoreList = array('.', '..');
